"""
a - список восстановленных времен
shp- шапка исходной таблицы из файла astronaut_time.csv
s - перменная для создания и открытия нового файла new_time.txt
f - переменная для открытия исходного файла astronaut_time.csv
"""
